...
| ENH-0009 | Dispose of retained legacy context data | Review gate passed; deletion pending | Metadata-only review, exact-table deletion, post-delete verification | Current worktree |
