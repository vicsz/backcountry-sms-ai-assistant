...
| BUG-0002 | Weather-dependent follow-up advice is rejected | Closed | Model extraction could fail or route activity planning to Ontario Parks; generated advice could use absolute safety wording | Added history fallback, deterministic activity routing, crossing-specific guidance, and safety-claim rejection | 10 BUG-0002-linked tests plus live capture | Pending | Redeployed demo capture passed; no SMS/SNS delivery |
